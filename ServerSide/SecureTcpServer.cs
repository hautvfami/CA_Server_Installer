...
namespace ServerSide
{
    public class SecureTcpServer : IDisposable
    {
        ...
        public SecureTcpServer(int listenPort, X509Certificate serverCertificate, SecureConnectionResultsCallback callback) : this(listenPort, serverCertificate, callback, null) { }
        ...
        public void StopListening()
        {
            if (!started) return;
            started = false;
            if (listenerV4 != null) listenerV4.Stop();
            if (listenerV6 != null) listenerV6.Stop();
        }
        ...
        void OnAcceptConnection(IAsyncResult result)
        {
            ...
            try
            {
                ...
                if (this.started) listener.BeginAcceptTcpClient(this.onAcceptConnection, listener);
                ...
                if (this.certValidationCallback != null) sslStream = new SslStream(client.GetStream(), leaveStreamOpen, this.certValidationCallback);
                else sslStream = new SslStream(client.GetStream(), leaveStreamOpen);

                sslStream.BeginAuthenticateAsServer(this.serverCert, this.clientCertificateRequired, this.sslProtocols, this.checkCertifcateRevocation, this.onAuthenticateAsServer, sslStream);
            }
            catch (Exception ex)
            {
                if (sslStream != null)
        ...
        public void Dispose()
        {
            ...
            {
                if (this.listenerV4 != null) listenerV4.Stop();
                if (this.listenerV6 != null) listenerV6.Stop();
                listenerV4 = null;
                listenerV6 = null;
